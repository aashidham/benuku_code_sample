...
public class MiniMain extends ConsoleProgram {
	public void run() {
		...
		// test1();   // uncomment me once you write Ant
		// test2();   // uncomment me once you write other animals
	}
	
	// Small, very simple test (Ant only).
	// Uncomment this once you have written the Ant.
	// You'll also need to un-comment the call to test1(); up in the run method.
	...
	*/
	...
	// You'll also need to un-comment the call to test2(); up in the run method.
